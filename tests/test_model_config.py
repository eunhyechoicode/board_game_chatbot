...
from board_game_chatbot.config.model_config import ModelConfig, get_model_config, load_config
...
class TestModelConfig:
    ...
    @patch('board_game_chatbot.config.model_config.ConfigLoader')
