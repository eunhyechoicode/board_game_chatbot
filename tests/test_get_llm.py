...
from board_game_chatbot.services.llm.get_llm import get_llm, LLM
...
class TestGetLLM(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.chat_openai_patch = patch('board_game_chatbot.services.llm.get_llm.ChatOpenAI')
    ...
    @patch('board_game_chatbot.services.llm.get_llm.get_llm_model')
